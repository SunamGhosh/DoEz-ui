...
const Home = () => {
  ...
  const serviceIcons = {
    ...
    PLUMBING: <Droplets size={42} className="text-blue-600" />,
    ELECTRICAL: <Zap size={42} className="text-yellow-600" />,
    MECHANICAL: <Wrench size={42} className="text-yellow-600" />,
    PAINTING: <Paintbrush size={42} className="text-orange-600" />,
    CARPENTRY: <Hammer size={42} className="text-indigo-600" />,
    GARDENARING: <Flower2 size={42} className="text-green-600" />,
    APPLIANCE: <Tv className="text-purple-600" />,
  };
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center pb-20 overflow-hidden bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10 w-full text-center">
            <div className="inline-flex items-center px-5 py-2 mb-8 rounded-full border border-teal-100 bg-teal-50 text-teal-700 font-bold text-sm shadow-sm">
              <CheckCircle2 size={16} className="mr-2" /> Trusted by 10,000+
              happy customers
            </div>
            ...
            <p className="text-lg md:text-2xl mb-12 max-w-2xl mx-auto text-gray-500 font-medium leading-relaxed">
              Book trusted local professionals for all your home service needs.
              Verified experts, transparent pricing, and guaranteed peace of
              mind.
            </p>
          ...
          <div className="max-w-4xl mx-auto bg-gray-900 rounded-[3.5rem] p-12 md:p-20 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 text-lg mb-10 max-w-xl mx-auto">
                ...
                today. Quality work is just a click away.
              </p>
