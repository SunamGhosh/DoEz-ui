    ...
    <div className="space-y-5">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">{filtered.length} sub services</p>
        </div>
      ...
      <div className="hidden sm:block bg-white rounded-2xl border border-gray-100 overflow-hidden">
        ...
        {filtered.length === 0
          ? <div className="py-12 text-center text-sm text-gray-400">No sub services found</div>
          : filtered.map((item) => (
      ...
      <div className="sm:hidden space-y-3">
        {filtered.length === 0
          ? <div className="py-12 text-center text-sm text-gray-400 bg-white rounded-2xl border border-gray-100">No sub services found</div>
          : filtered.map((item) => (
